...
export const testimonials = [
  {
    quote:
      "I consulted Dr. Sandeep for severe knee pain and the approach felt very reassuring. He explained the condition clearly and the treatment gave me real relief.",
    name: "Ravi Kumar",
    note: "MVP Colony, Visakhapatnam"
  },
  {
    quote:
      "After my shoulder injury, I was worried about surgery. Dr. Sandeep guided me step by step and I felt confident throughout the recovery process.",
    name: "Sneha Reddy",
    note: "Madhurawada, Visakhapatnam"
  },
  {
    quote:
      "My father was treated after an accident and the care was prompt and professional. The follow-up was excellent and we were kept informed at every stage.",
    name: "Lakshmi Prasad",
    note: "Gajuwaka, Visakhapatnam"
  },
  {
    quote:
      "What stood out most was the patience and honesty during the consultation. We never felt rushed and every question about treatment was answered properly.",
    name: "Anusha Devi",
    note: "Seethammadhara, Visakhapatnam"
  }
];
